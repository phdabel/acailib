...
${OBJECTDIR}/neuralnet/Neuron.o: neuralnet/Neuron.cpp
	${MKDIR} -p ${OBJECTDIR}/neuralnet
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/neuralnet/Neuron.o neuralnet/Neuron.cpp
...
${OBJECTDIR}/neuralnet/Neuron_nomain.o: ${OBJECTDIR}/neuralnet/Neuron.o neuralnet/Neuron.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/neuralnet/Neuron_nomain.o neuralnet/Neuron.cpp;\
	else  \
